            ...
            <div class="p-6">
                ...
                <div class="bg-primary/10 p-4 rounded-lg mb-4">
                    ...
                    <div class="flex h-4 rounded-full overflow-hidden bg-white mb-1">
                        <div class="bg-primary" style="width: <?php echo e($currentUser->binaryPts?->left_points ?? 0); ?>%">
                        </div>
                        <div class="bg-secondary" style="width: <?php echo e($currentUser->binaryPts?->right_points ?? 0); ?>%">
                        </div>
                    </div>
                    <div class="flex justify-between text-sm text-ink">
                        <span><?php echo e($currentUser->binaryPts?->left_points ?? 0); ?> puntos</span>
                        <span><?php echo e($currentUser->binaryPts?->right_points ?? 0); ?> puntos</span>
                    </div>
                </div>
