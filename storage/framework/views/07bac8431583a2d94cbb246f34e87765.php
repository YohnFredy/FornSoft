...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Fornuvi','iconBlade' => 'arrow-uturn-left','routes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['home', 'products.index', 'dashboard']),'items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                ['name' => 'Inicio', 'route' => 'home', 'iconBlade' => 'home'],
                ['name' => 'Tienda', 'route' => 'products.index', 'iconBlade' => 'shopping-cart'],
                ['name' => 'Oficina', 'route' => 'dashboard', 'iconBlade' => 'building-office'],
            ])]); ?>
