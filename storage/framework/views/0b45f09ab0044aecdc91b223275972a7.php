                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $businessData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <th scope="row" class="px-6 py-4 whitespace-nowrap">
                                <!--[if BLOCK]><![endif]--><?php if($data->latestImage): ?>
                                    <img class=" h-10 mx-auto" src="<?php echo e(Storage::url($data->business->latestImage->path)); ?>"
                                        alt="<?php echo e($data->business->name); ?>">
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </th>
                            <td class="px-6 py-4 whitespace-nowrap"><?php echo e($data->business->name); ?></td>
                            <td class="px-6 py-4 "><?php echo e($data->business->nit); ?></td>

                            <td class="px-6 py-4 whitespace-nowrap">
                                <!--[if BLOCK]><![endif]--><?php if($data->is_active): ?>
                                    <span
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <div class="flex items-center space-x-3">
                                    <a href="<?php echo e(route('admin.businesses.show', $data)); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.businesses.destroy', $data)); ?>" method="POST"
...
<?php /**PATH C:\Users\Fredy\Herd\fornuvi\resources\views/livewire/admin/businesses/business-index.blade.php ENDPATH**/ ?>