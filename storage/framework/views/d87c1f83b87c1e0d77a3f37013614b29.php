...
<?php endif; ?>
                ...
                <div class="relative mb-5">
                    ...
                    <select wire:model.live="selectedStoreType" id="store_type"
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $storeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $storeType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($storeType->id); ?>"><?php echo e(__($storeType->name)); ?></option>
                        ...
                        <tbody class="bg-white divide-y divide-slate-300">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $businessData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-100 transition-colors duration-200 group">
                                    <th scope="row" class="px-4 py-2 text-ink min-w-50">
                                        <div class="grid grid-cols-3 gap-4 w-full items-center">
                                            ...
                                            <div class="col-span-1">
                                                <!--[if BLOCK]><![endif]--><?php if($data->business->latestLogo): ?>
                                                    <img src="<?php echo e(asset('storage/' . $data->business->latestLogo->path)); ?>"
                                                        alt="<?php echo e($data->business->name); ?>"
                                    ...
                                    <td class="px-4 py-2 max-w-xs"><?php echo e($data->address); ?></td>
                                    <td class="px-4 py-2">
                                        <div class="flex flex-wrap gap-1">
                                            <!--[if BLOCK]><![endif]--><?php $__empty_2 = true; $__currentLoopData = $data->storeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $storeType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <span
                                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-primary/5 text-primary whitespace-nowrap">
                                                    <?php echo e(__($storeType->name)); ?>
                                    ...
                                    <td class="px-4 py-2">
                                        <a href="<?php echo e(route('companies.show', $data)); ?>" class="">
                                            <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($data->city || $data->city_id): ?>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div class="flex items-center text-sm text-primary">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(!empty($data->city)): ?>
                                        <?php echo e($data->city); ?>

                                    <?php else: ?>
                                        <?php echo e($data->city_id); ?>
                            ...
                            <div class=" flex items-center">
                                <!--[if BLOCK]><![endif]--><?php if($data->business->latestLogo): ?>
                                    <img src="<?php echo e(asset('storage/' . $data->business->latestLogo->path)); ?>"
                                        alt="<?php echo e($data->business->name); ?>" class="h-15 w-20 object-contain mb-2">
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!empty($data->address)): ?>
                                <div class="flex items-start">
                                    ...
                                    <span
                                        class="text-secondary hover:text-primary font-medium"><?php echo e($data->address); ?></span>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
