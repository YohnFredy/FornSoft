                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-2xl font-bold text-ink"> $<?php echo e(number_format($summaryCommission ?? 0, 0)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1">
                            <p class="text-sm font-medium text-secondary">Total Comisiones </p>
                            <p class="text-2xl font-bold text-ink"> $<?php echo e(number_format($summaryCommission ?? 0, 0)); ?></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow-md shadow-ink rounded-xl border border-gray-100 overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <!--[if BLOCK]><![endif]--><?php switch($commission->type):
                                    case (1): ?>
                                        <p>Bolsa Global</p>
                                    <?php break; ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div
                                    ...
                                    <?php echo e(number_format($commission->vfb ?? 0, 1)); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                $<?php echo e(number_format($commission->commission, 0)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e(\Carbon\Carbon::parse($commission->end)->format('Y-m-d')); ?>
...
<?php /**PATH C:\Users\Fredy\Herd\fornuvi\resources\views/livewire/office/commissions.blade.php ENDPATH**/ ?>